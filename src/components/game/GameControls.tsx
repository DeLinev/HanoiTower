...
export function GameControls({ timePassed, timeRemaining, isTimerRunning, onReset, onPause, onResume, className }: GameControlsProps) {
    ...
    return (
        <div className={className}>
            <Card>
                <div className="flex flex-col md:flex-row items-center justify-between gap-x-10 gap-y-5">
